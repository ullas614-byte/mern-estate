      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <nav className="flex items-center space-x-12">
            <Link
              to="/"
              className="text-sm hidden sm:inline font-bold text-slate-700 hover:text-yellow-500 transition"
            >
              Home
            </Link>
            <Link
              to="/about"
              className="text-sm hidden sm:inline font-bold text-slate-700 hover:text-yellow-500 transition-all uppercase tracking-widest"
            >
              About
            </Link>
            <Link
              to="sign-in"
              className="text-sm font-bold text-slate-700 hover:text-yellow-500 transition-all uppercase tracking-widest"
            >
              Signin
            </Link>
